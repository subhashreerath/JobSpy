...
# Run JobSpy for all three sites (Indeed, Glassdoor, Google)
jobs = scrape_jobs(
    site_name=["indeed", "glassdoor", "google"],  # All three sites
    search_term="Cloud Engineer, DevOps Engineer",  # Your keywords
    location="Germany",  # Optional: location filter
    country_indeed="germany",  # Germany for Indeed
